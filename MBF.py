...
def loginSC():
	...
	if username =="dark" and password =="fb":
		...
		os.system('xdg-open https://www.youtube.com/channel/UCaa-7rscQ5Ttzb8E87EgW9A')
		time.sleep(1)
		login()
	else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCPY2-OYtasxEH1mSYownAhQ')
				menu()
